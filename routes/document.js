...
const { sendDocument, listSentDocuments: listSentDocuments, listReceivingDocuments, uploadMiddleware, markAsRead , deleteDocuments} = require('../controllers/DocumentController');
